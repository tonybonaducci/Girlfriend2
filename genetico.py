...
def valor_poblacion_age(seeds,train_set, test_set, train_set_size, test_set_size,atributes):
    ...
    return peor, segundo_peor, indice_peor, indice_segundo_peor
...
def AGG(train_set, test_set, train_set_size, test_set_size,weights,atributes):
...
def AGE(train_set, test_set, train_set_size, test_set_size,weights,atributes):
    ...
    while(n_evaluaciones<5):
        ...
        c_1, c_2 = BLX_alpha(padre_1,padre_2,alpha) 
        ...
        #-----reemplazamiento-----
        #los dos hijos compiten para sus tituir a el/los peores de la población
        
        peor, segundo_peor, i_peor, i_segundo_peor = valor_poblacion(poblacion,train_set, test_set, train_set_size, test_set_size,atributes)
        n_evaluaciones = n_evaluaciones + 1
